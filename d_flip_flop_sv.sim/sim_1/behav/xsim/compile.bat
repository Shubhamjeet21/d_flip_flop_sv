...
REM
REM Generated by Vivado on Tue Jun 17 14:38:00 -0400 2025
...
echo "xvlog --incr --relax -L uvm -prj d_flip_flop_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj d_flip_flop_tb_vlog.prj -log xvlog.log
